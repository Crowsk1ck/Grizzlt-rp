...
const ranks = [
  {
    name: 'Лідер',
    salary: '$ 250 000+',
    access: 'Фінальні рішення, дипломатія, стратегія, склад.',
    icon: Crown,
  },
  {
    name: 'Заступник',
    salary: '$ 180 000',
    access: 'Керує напрямами, контролює дисципліну, приймає рішення по складу.',
    icon: Star,
  },
  {
    name: 'Радник',
    salary: '$ 130 000',
    access: 'Дипломатія, конфлікти, внутрішній баланс, допомога старшому складу.',
    icon: Shield,
  },
  {
    name: 'Куратор',
  ...
  },
  {
    name: 'Боєць',
    salary: '$ 55 000',
    access: 'Контракти, активності, сімейні виїзди, допомога новачкам.',
    icon: Users,
  },
  {
    name: 'Кандидат',
    salary: 'Випробувальний термін',
    access: 'Навчання правилам родини, базові активності, співбесіда.',
